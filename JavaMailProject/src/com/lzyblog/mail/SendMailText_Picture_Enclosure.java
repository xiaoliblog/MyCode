...
public class SendMailText_Picture_Enclosure {
    ...
    //收件人邮箱地址
    public static String recipientAddress = "xxxxxx@qq.com";
    //发件人邮箱账户名
    public static String senderAccount = "xxxxx@163.com";
    //发件人邮箱账户密码
    ...
    public static MimeMessage getMimeMessage(Session session) throws Exception{
        ...
        text.setContent("这是一张图片<br/><a href='https://lzyblog.github.io/2020/12/31/JavaMail邮件实现'><img src='cid:mailTestPic'/></a>", "text/html;charset=UTF-8");
